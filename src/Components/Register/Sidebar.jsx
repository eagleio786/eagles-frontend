...
const Sidebar = ({ showSidebar, setShowSidebar }) => {
  ...
  return (
    <>
      <div
        className={`fixed top-0 left-0 h-screen w-full bg-gray-900 bg-opacity-50 transition-opacity duration-500 ${
      ...
      <div
        className={`fixed top-0 h-screen bg-black py-6 px-4 transition-all duration-500 ease-in-out ${
