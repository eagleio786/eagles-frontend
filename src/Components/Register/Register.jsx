          ...
          <div className='flex-1 p-2 md:p-4 lg:p-2'>
            <div className='flex justify-end'>
              <div
                ...
                className='text-textColor3 text-center inline-block text-xs px-2 py-4 rounded-full bg-textColor3 bg-opacity-30 w-[120px] overflow-x-scroll cursor-pointer'
                style={{
                  scrollbarWidth: 'none',
                }}
              >
            ...
            <button
              className={`mt-4 px-4 w-full py-2 bg-blue-600 hover:bg-blue-700 rounded-lg flex items-center justify-center ${
                !isConnected || loading
